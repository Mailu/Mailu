...
.. code-block:: bash
  ...
  rspamc -h mailu-rspamd:11334 -P mailu -f 13 fuzzy_add /mail/user\@example.com/.Ham_Learn/cur/
  rspamc -h mailu-rspamd:11334 -P mailu learn_ham /mail/user\@example.com/.Ham_Learn/cur/
  
This should learn every file located in the ``Ham_Learn`` folder from user@example.com (first line adds mail to fuzzy module, second one to bayes one)

Likewise, to learn all messages within the folder ``Spam_Learn`` as spam messages :

.. code-block:: bash

  rspamc -h mailu-rspamd:11334 -P mailu -f 11 fuzzy_add /mail/user\@example.com/.Spam_Learn/cur/
  rspamc -h mailu-rspamd:11334 -P mailu learn_spam /mail/user\@example.com/.Spam_Learn/cur/
